...
export const JapanIcon = React.memo<{size?: number; color?: string}>(({size, color}) => {
  return (
    <svg
      version='1.1'
      id='_x32_'
    ...
    >
      <path
        className='st0'
        d='M259.119,460.031c0,13.406-10.875,24.266-24.266,24.266h-51.031c-13.406,0-24.266-10.859-24.266-24.266
      ...
      <path
        className='st0'
        d='M36.9,365.688h-4.266c-13.391,0-24.266,10.875-24.266,24.266v33.516c0,13.406,6.25,24.281,16.953,24.281h2.672
      ...
      <path
        className='st0'
        d='M338.322,161.438c-11.422,0-21.297,7.969-23.703,19.125l-13.563,62.531
      ...
      <path
        className='st0'
        d='M487.947,108.75c-2.188,11.422-12.172,19.688-23.844,19.688H358.588c-7.234,0-14.109-3.203-18.688-8.781
