...
const BpCheckBox = React.memo((props: CheckboxProps) => (
  <Checkbox
    sx={{
...
BpCheckBox.displayName = 'BpCheckBox';
...
export const SingleCheckBox = React.memo<P>(props => {
  return (
    <CheckBoxWrapper>
      {/*<BpCheckBox*/}
      {/*  value={props.value}*/}
      ...
      {/*こっちでもよかったんだけど、デザイン的に上を採用、もし下に戻りたければご自由にw*/}
      <Checkbox
        sx={{padding: 0}}
        value={props.value}
        color={'primary'}
